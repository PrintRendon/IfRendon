...
class NBELButtonPressedEventHandler(adsk.core.CommandCreatedEventHandler):
    ...
    def notify(self, args):
        try:
            ...
            selectionInput3.addSelectionFilter('CircularEdges')
            ...
            Xposition = inputs.addValueInput('_X', 'Coordenate X: ','',adsk.core.ValueInput.createByReal(0))  
            Yposition = inputs.addValueInput('_Y', 'Coordenate Y: ','',adsk.core.ValueInput.createByReal(0))      
    ...
    def notify(self, args):
        ...
        try:
            ...
            if point1 and point2 and point3 and point4:
                Angle_1 = getAngle1(point1, point2, point3, point4,)
...
def getAngle1(point1, point2, point3, point4) -> float:          
    try:    
        app = adsk.core.Application.get()
        ui  = app.userInterface
        design = app.activeProduct
